...
<?php if ($order->has_status('pending')) : ?>
    <p><?php echo wp_kses(
            sprintf(
                ...
                _x('An order has been created for you to renew your WPcare subscription on %1$s. To pay for this invoice online, please use the following link: %2$s. If paying by check, please refer to the payment details at the bottom of this notice.', 'In customer renewal invoice email', 'woocommerce-subscriptions'),
